...
SEARCHES = [["breadth_first_search", breadth_first_search, ""], # 1
            ['breadth_first_tree_search', breadth_first_tree_search, ""], # 2
            ['depth_first_graph_search', depth_first_graph_search, ""], # 3 
            ['depth_limited_search', depth_limited_search, ""], # 4
            ['uniform_cost_search', uniform_cost_search, ""], # 5
            ['recursive_best_first_search', recursive_best_first_search, 'h_1'], # 6
            ['greedy_best_first_graph_search', greedy_best_first_graph_search, 'h_1'], # 7
            ['astar_search', astar_search, 'h_1'], # 8
            ['astar_search', astar_search, 'h_ignore_preconditions'], # 9
            ['astar_search', astar_search, 'h_pg_levelsum'], # 10
            ]
